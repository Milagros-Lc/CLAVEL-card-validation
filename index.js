...
let botonRegistrarseIni = document.getElementById('botonRegistrarse');

let botonIniciarSesion, inputUsuario, seccionIniciarSesion,
    formInicio, sms, productos, inputContraseñaRegistro, formRegistrarse,
    inputUsuarioRegistro, botonRegistrarse;
...
function registrarse() {
    ...
    seccionIniciarSesion.style.display = "block";
    //formInicio.style.display = "none";
    formRegistrarse = document.createElement('div');
    seccionIniciarSesion.appendChild(formRegistrarse);
    formRegistrarse.setAttribute('class', 'formInicio')

    let h3registrar = document.createElement('h3');
    let textoh3 = document.createTextNode('Registro Nuevo');
    h3registrar.appendChild(textoh3);
    formRegistrarse.appendChild(h3registrar);

    let correoRegistrar = document.createElement('label');
    let textoCorreoRegistrar = document.createTextNode('Ingrese Correo Electrónico:');
    correoRegistrar.appendChild(textoCorreoRegistrar);
    formRegistrarse.appendChild(correoRegistrar);
    correoRegistrar.setAttribute('class', 'labelFormulario');

    inputUsuarioRegistro = document.createElement('input');
    formRegistrarse.appendChild(inputUsuarioRegistro);
    inputUsuarioRegistro.setAttribute('class', 'inputFormulario');
    localStorage.setItem("correoGuardado", inputUsuarioRegistro.value);

    let contraseñaRegistro = document.createElement('label');
    let textoContraseñaRegistro = document.createTextNode('Contraseña');
    contraseñaRegistro.appendChild(textoContraseñaRegistro);
    formRegistrarse.appendChild(contraseñaRegistro);
    contraseñaRegistro.setAttribute('class', 'labelFormulario');

    inputContraseñaRegistro = document.createElement('input');
    formRegistrarse.appendChild(inputContraseñaRegistro);
    inputContraseñaRegistro.setAttribute('class', 'inputFormulario');
    localStorage.setItem("contraseñaGuardada", inputContraseñaRegistro.value);

    let btnRegistrar = document.createElement('button');
    let textoBotonIniRegistrar = document.createTextNode('Registrarse');
    btnRegistrar.appendChild(textoBotonIniRegistrar);
    formRegistrarse.appendChild(btnRegistrar);
    btnRegistrar.setAttribute('id', 'buttonRegistrarse');
    botonRegistrarse = document.getElementById('buttonRegistrarse');
    ...
    sms.setAttribute('class', 'labelNumeroValido');
 */
    botonRegistrarse.addEventListener('click', mostrarInicio);


}
botonRegistrarseIni.addEventListener('click', registrarse);

function mostrarInicio() {


    if (inputUsuario.value == correoGuardado) {
        ...
        botonIniciar.innerHTML = "Bienvenido!"
